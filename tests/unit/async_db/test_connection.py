...
async def test_transaction_sequence_id_handling(connection: Connection) -> None:
...
async def test_transaction_sequence_id_inheritance_on_cursor_creation(
    connection: Connection,
) -> None:
...
async def test_multi_cursor_transaction_sequence_id_sync(
    connection: Connection,
) -> None:
