...
def test_executemany_bulk_insert_non_insert_fails(cursor: Cursor):
...
def test_executemany_bulk_insert_multi_statement_fails(cursor: Cursor):
...
def test_executemany_bulk_insert_empty_params_fails(cursor: Cursor):
