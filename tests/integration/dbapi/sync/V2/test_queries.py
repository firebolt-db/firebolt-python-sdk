...
from firebolt.db import Binary, Connection, CursorV2, OperationalError, connect
...
def test_drop_create(connection: Connection) -> None:
    ...
    def test_query(c: CursorV2, query: str) -> None:
        c.execute(query)
...
def test_insert(connection: Connection) -> None:
    ...
    def test_empty_query(c: CursorV2, query: str) -> None:
...
def test_parameterized_query(connection: Connection) -> None:
    ...
    def test_empty_query(c: CursorV2, query: str, params: tuple) -> None:
