...
from firebolt.client import DEFAULT_API_URL, AsyncClient, raise_on_4xx_5xx
...
async def _resolve_engine_url(
    engine_name: str, username: str, password: str, api_endpoint: str, account_id: str
) -> str:
        ...
        for param, name in (
            ...
            if engine_name is not None:
                engine_url = await _resolve_engine_url(
                    engine_url, username, password, api_endpoint
                )
